...
public class ComboDBCatalogSelector extends ComboDBModel implements Observer {
	...
	public void update(Subject o) {
		...
		for (DBTable dbtable : list) {
			String cat = dbtable.getTableCat();
			if (cat != null) {
		...
		while (enumeration.hasMoreElements()) {
			catalogs.add(enumeration.nextElement());
