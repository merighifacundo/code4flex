...
public class FlexProjectConfigurationTemplate extends VelocityCodeGenerator {
	
	private EntryPointGenerator entryPoint;
	...
	public void generate() {
		try {
			...
			context.put("proyectName", entryPoint.getMainPointFileName());
	...
	public String getFinalPath() {
		...
		return this.mainGenerator.getProyectDestPath() ;
	}
