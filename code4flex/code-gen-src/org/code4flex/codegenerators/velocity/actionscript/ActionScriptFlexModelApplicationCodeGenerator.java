...
public class ActionScriptFlexModelApplicationCodeGenerator extends
	...
	public void generate() {
		try {
			...
			String namespacePath = getNamespacePath(modelApplication);
			...
			FileWriter fwriter = new FileWriter(getFinalPath() + File.separator
					+ modelApplication.getClassName() + ".as");
			VelocityContext context = new VelocityContext();
			context.put("modelApplication", modelApplication);
			context.put("package", modelApplication.getNamespace());
