...
public class PhpEntityConverterClassCodeGenerator extends PhpVelocityCodeGenerator {
		...
		try {
			...
			while (it.hasNext()) {
				...
				FileWriter fwriter = new FileWriter(getFinalPath() + File.separator
						+ table.getClassName() + "Converter.php");
...
//		return  File.separator +"php" + File.separator + this.getProyectName().toLowerCase() +  File.separator + "convertentities" + File.separator ;
//	}
