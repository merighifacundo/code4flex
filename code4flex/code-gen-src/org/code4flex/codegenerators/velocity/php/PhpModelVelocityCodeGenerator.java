...
public class PhpModelVelocityCodeGenerator extends PhpVelocityCodeGenerator {
	...
	public void generate() {
		try {
			...
			while (it.hasNext()) {
				PHPClass table = (PHPClass) it.next();
				...
				FileWriter fwriter = new FileWriter(getFinalPath()+ File.separator + table.getClassName()+".php");
				...
				// file = "ar/com/phpmysqlinstaller/connect/facus.vm";
...
//		return  File.separator +"php" + File.separator + this.getProyectName().toLowerCase() +  File.separator + "model" + File.separator ;
//	}
