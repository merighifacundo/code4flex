...
public class PhpDaoTesterCodeGenerator extends PhpVelocityCodeGenerator {
...
//		return  File.separator +"php" + File.separator + this.getProyectName().toLowerCase() +  File.separator + "test" + File.separator ;
//	}
